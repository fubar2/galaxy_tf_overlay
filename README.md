...
It is not intended for developers who focus on building Galaxy tools, because given time to learn to use them, there are more flexible tools and methods.
...
Even using an automated generator, planning and preparation are the keys to efficiently creating a useful tool.
