...
"""
python scripts/create_galaxy_user.py --galaxy_root /galaxytf  db_url "sqlite:///<data_dir>/universe.sqlite?isolation_level=IMMEDIATE"
...
"""
GALDIR = "/evol/galaxytf"


def run_wait_gal(url='http://localhost:8080', galdir=GALDIR):
    ALREADY=False
    try:
...
def stop_gal(url="http://localhost:8080", galdir=GALDIR):
